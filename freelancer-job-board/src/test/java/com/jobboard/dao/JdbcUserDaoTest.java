...
public class JdbcUserDaoTest extends BaseDaoTest {
    protected static final User USER_1 = new User(1, "cali", "hashedpassword", "ROLE_CLIENT");
    ...
    public void findAll_returns_all_users() {
        ...
        assertEquals(1, users.size(), "getUsers returned a list with the incorrect number of users");
